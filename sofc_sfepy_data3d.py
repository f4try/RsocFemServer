...
ebcs = {
    ...
    'Bottomconnector': ('bottomconnector', {'phis3.0': V_cell}),  # V_cell000
    'OOmega_Surface_T2': ('Omega_Surface_T2', {'c_h2a.0': xH2, 'c_h2oa.0': 1-xH2}),
    'OOmega_Surface_B1': ('Omega_Surface_B1', {'c_o2c.0': xO2, 'c_n2c.0': 1-xO2}),
    'Topinlet': ('topinlet', {'p1.0': pfuel}),  # V_cell000
    'Topoutlet': ('topoutlet', {'p1.0': 1.0}),
    'Bottomoutlet': ('bottomoutlet', {'p2.0': 1.0}),  # V_cell000
    'Bottominlet': ('bottominlet', {'p2.0': pair}),
...
solvers = {
    ...
    # 'ts': ('ts.simple', {'t0': t0, 't1': t1, 'dt': None, 'n_step': n_step, 'verbose': 1, }),
}
