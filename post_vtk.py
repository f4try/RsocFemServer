...
def run(filename='static/3dcell.vtk',output='static/'):
    ...
    plotter.show(cpos=cpos,screenshot=output+'3dcell_mesh.png')

    plotter = pv.Plotter(off_screen=True)
    plotter.add_mesh(mesh,scalars='phil',cmap='jet')
    plotter.show(cpos=cpos,screenshot=output+'3dcell_phil.png')

    plotter = pv.Plotter(off_screen=True)
    plotter.add_mesh(mesh,scalars='phis1',cmap='jet')
    plotter.show(cpos=cpos,screenshot=output+'3dcell_phis1.png')

    plotter = pv.Plotter(off_screen=True)
    plotter.add_mesh(mesh,scalars='phis3',cmap='jet')
    plotter.show(cpos=cpos,screenshot=output+'3dcell_phis3.png')

    plotter = pv.Plotter(off_screen=True)
    plotter.add_mesh(mesh,scalars='T',cmap='jet')
    plotter.show(cpos=cpos,screenshot=output+'3dcell_T.png')

    plotter = pv.Plotter(off_screen=True)
    plotter.add_mesh(mesh,scalars='c_h2a',cmap='jet')
    plotter.show(cpos=cpos,screenshot=output+'3dcell_c_h2a.png')

    plotter = pv.Plotter(off_screen=True)
    plotter.add_mesh(mesh,scalars='c_h2oa',cmap='jet')
    plotter.show(cpos=cpos,screenshot=output+'3dcell_c_h2oa.png')

    plotter = pv.Plotter(off_screen=True)
    plotter.add_mesh(mesh,scalars='c_n2c',cmap='jet')
    plotter.show(cpos=cpos,screenshot=output+'3dcell_c_n2c.png')

    plotter = pv.Plotter(off_screen=True)
    plotter.add_mesh(mesh,scalars='c_o2c',cmap='jet')
    plotter.show(cpos=cpos,screenshot=output+'3dcell_c_o2c.png')

    plotter = pv.Plotter(off_screen=True)
    plotter.add_mesh(mesh,scalars='p1',cmap='jet')
    plotter.show(cpos=cpos,screenshot=output+'3dcell_p1.png')

    plotter = pv.Plotter(off_screen=True)
    plotter.add_mesh(mesh,scalars='p2',cmap='jet')
    plotter.show(cpos=cpos,screenshot=output+'3dcell_p2.png')
